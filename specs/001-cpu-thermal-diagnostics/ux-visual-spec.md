...
Se guardan posición, tamaño restaurado y estado maximizado al mover, redimensionar o cerrar. No se restaura el estado minimizado. Tamaño mínimo 480×600 px lógicos; primer arranque 1100×760 centrado. Antes de aplicar una posición se comprueba que una parte utilizable quede dentro de un monitor activo; si no, la ventana se centra en la pantalla principal respetando su tamaño mínimo.
