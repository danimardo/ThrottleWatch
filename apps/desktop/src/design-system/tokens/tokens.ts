...
export const COLOR_TOKENS: ColorToken[] = [
  ...
  { name: 'text-tertiary', value: { dark: '#98989D', light: '#5F6068' }, usage: 'Texto auxiliar que debe conservar contraste AA en superficies oscuras y claras.' },
  { name: 'accent-blue', value: { dark: '#4DA3FF', light: '#005BB7' }, usage: 'Color de sistema: navegación activa, foco, toolbar, cifras neutras. Nunca para un estado de alerta.' },
